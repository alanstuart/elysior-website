...
function buildCopy(lang) {
  ...
  return {
    ...
    portfolio: {
      ...
      noteCta: L({
        es: 'Quiero una solución para mi negocio',
        en: 'I want a solution for my business',
        pt: 'Quero uma solução para o meu negócio',
        fr: 'Je veux une solution pour mon entreprise',
      }),
    },
    precios: {
